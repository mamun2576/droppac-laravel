<div>
    <form wire:submit.prevent="setDropoffAddress">
            ...
            <div class="flex flex-col sm:flex-row sm:space-x-8">
                <div class="flex flex-col w-full ">
                    ...
                    <div class="w-full">
                        ...
                        <x-jet-input name="business_name" type="text" class="mt-1 block w-full" wire:model.defer="dropoff_address.business_name" autocomplete="business_name" />
                    ...
                    <div class="flex flex-col sm:flex-row sm:space-x-8 my-6" >
                        <div class="w-full">
                            ...
                            <select name="knutsford_office" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" autocomplete="knutsford_office" wire:model.defer="dropoff_address.knutsford_office"> 
                        ...
                        <div class="w-full">
                            ...
                            <x-jet-input name="knutsford_receipt_number" type="text" class="mt-1 block w-full" wire:model.defer="dropoff_address.knutsford_receipt_number" />
                            <x-jet-input-error for="knutsford_receipt_number" class="mt-2" autocomplete="knutsford_receipt_number"/>
                        </div>
                    </div> 
                    <div class=" flex flex-row items-center">
                        <x-jet-input name="knutsford_paid" type="checkbox" class="mr-4" wire:model.defer="dropoff_address.knutsford_paid" autocomplete="knutsford_paid" /> 
                    ...
                    <div class="w-full">
                        ...
                        <x-jet-input type="text" class="mt-1 block w-full" id="address" wire:model.defer="dropoff_address.address"/>
                        <x-jet-input-error for="address" class="mt-2" />
                    </div>
                    <!-- community -->
                    <div class="w-full">
                        <x-jet-label for="community" value="{{ __('Community, town, etc.') }}" />
                        <x-jet-input id="community" type="text" class="mt-1 block w-full" wire:model.defer="dropoff_address.community" />
                        <x-jet-input-error for="community" class="mt-2" />
                    </div>
                    <div class="w-full">
                            <x-jet-label for="parish" value="{{ __('Parish') }}"/>
                            <select wire:model.defer="dropoff_address.parish" name="parish" class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" autocomplete="dropoff_address.parish">
